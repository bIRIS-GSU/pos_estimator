...
from pos_estimator_msgs.msg import AcquireTrainData, AcquireEvalData, EstimatedPose, RGBEvalImage, RGBTrainImage
...
def rgb_acquisition_node():
    ...
    rospy.Subscriber('color/image', Image, callback_rgb_image)
